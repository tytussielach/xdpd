...
public:
	...
	*/	
	...
	/*virtual*/ inline void pop_gtp(uint16_t ether_type);
	...
	/*virtual*/ inline rofl::fgtpuframe*	push_gtp(uint16_t ether_type);
...
protected:
	...
	inline rofl::fframe* frame_insert(rofl::fframe *append_to, rofl::fframe *frame);
	inline void frame_append(rofl::fframe *frame);
	inline void frame_push(rofl::fframe *frame);
	inline void frame_pop(rofl::fframe *frame);

	inline void parse_ether(uint8_t *data, size_t datalen);
	inline void parse_vlan(uint8_t *data, size_t datalen);
	inline void parse_mpls(uint8_t *data, size_t datalen);
	inline void parse_pppoe(uint8_t *data, size_t datalen);
	inline void parse_ppp(uint8_t *data, size_t datalen);
	inline void parse_arpv4(uint8_t *data, size_t datalen);
	inline void parse_ipv4(uint8_t *data, size_t datalen);
	inline void parse_icmpv4(uint8_t *data, size_t datalen);
	inline void parse_udp(uint8_t *data, size_t datalen);
	inline void parse_tcp(uint8_t *data, size_t datalen);
	inline void parse_sctp(uint8_t *data, size_t datalen);
	inline void parse_gtp(uint8_t *data, size_t datalen);

	//Insert/pop frame
	inline void pop_header(enum header_type type, unsigned int start, unsigned int end);
	inline void push_header(enum header_type type, unsigned int start, unsigned int end);
...
*/
rofl_result_t static_pktclassifier::pkt_push(unsigned int num_of_bytes, unsigned int offset){
	return pkt->push(num_of_bytes,offset);
}
rofl_result_t static_pktclassifier::pkt_pop(unsigned int num_of_bytes, unsigned int offset){
	return pkt->pop(num_of_bytes,offset);
}
rofl_result_t static_pktclassifier::pkt_push(uint8_t* push_point, unsigned int num_of_bytes){
	return pkt->push(push_point,num_of_bytes);
}
rofl_result_t static_pktclassifier::pkt_pop(uint8_t* pop_point, unsigned int num_of_bytes){ 
