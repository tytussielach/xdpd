...
#include "src/io/packet_classifiers/c_pktclassifier/classifier_monohdr.h"
...
#define PACKET_STRING {	0x00,0x1a,0x64,0x11,0xf2,0x6d, \
						0x3c,0x97,0x0e,0x5f,0xbb,0x67, \
						0x08,0x00, \
						0x45,0x00, \
						0x00,0x34,0x62,0x07,0x40, \
						0x00,0x40,0x06,0xf3,0x85, \
						0xac,0x10,0xfa,0x8b,0xbc,0xa5,0x81,0xf5,0xd1,0xae,0x00,0x50,0xac,0x4d,0xfc,0x9e,0x9b,0x16,0x9f,0x73,0x80,0x10,0x01,0x3a,0xe5,0x5d,0x00,0x00,0x01,0x01,0x08,0x0a,0x00,0x1a,0x5d,0xfa,0x5c,0xc6,0x6d,0x63}
#define PACKET_SIZE 66
//uint8_t packet[2] = { 0x00,0x22 };
uint8_t packet[PACKET_SIZE] = PACKET_STRING;
